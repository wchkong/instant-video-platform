...
public class DateUtils {
    ...
    public static final String DATE_FORMAT_YYYYMMMDD_HHMMSS_UTC = "yyyy-MM-dd'T'HH:mm:ss.SSSXXX";
    ...
    public static long compareToday(Date date) {
        ...
        return (System.currentTimeMillis() - date.getTime()) / (1000 * 60 * 60 * 24L);
    }
    ...
    public static int getDateDifferenceInDayUnit(Date date1, Date date2) {
        if (date1 == null || date2 == null)
            return Integer.MAX_VALUE;
        return (int) ((date1.getTime() - date2.getTime()) / (1000 * 3600 * 24L));
    }
